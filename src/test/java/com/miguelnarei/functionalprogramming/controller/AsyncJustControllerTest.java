...
class AsyncJustControllerTest {
    ...
    void syncTest() {
        ...
        ResponseEntity<PurchaseResonseDto> response = new TestRestTemplate().postForEntity("http://localhost:8080/async-just-controller/purchases",
